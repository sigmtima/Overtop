...
namespace EnemyAI
{
    ...
    public class EnemyWanderState : BaseState<EnemyContext>
    {
        ...
        private float _nextCheckUpdateInterval = 1f;
        ...
        private void Wander()
        {
            Vector2 target = (Vector2)Context.Controller.transform.position + (Random.insideUnitCircle *
                        Random.Range(
                    ...
                    _nextWanderTime = Time.time + Random.Range(Context.Controller.Data.minMoveInterval, Context.Controller.Data.maxMoveInterval);
        }
