...
namespace Enemy_AI
{
    public class EnemyController : StateMachine<EnemyContext>, ITakeDamage
    {
        ...
        [FormerlySerializedAs("health")] [SerializeField] private EnemyHealth _enemyHealth;
        ...
        public void Awake()
        {
          _enemyHealth.Initialize(Data.enemyHealth);
        ...
        public void TakeDamage(float damage)
        {
            ...
            if (_enemyHealth.CurrentHealth <= 0) Die();
        }
